...
layers:
  ...
  - id: ch4-wetlands-emissions-d-jra
    stacCol: lpjwsl-wetlandch4-daygrid-v2
    name: (Daily JRA) LPJ-wsl Model Wetland CH₄ Emissions
    type: raster
    description: Daily CH₄ emissions from wetlands constructed using the LPJ-wsl model
    initialDatetime: newest
    projection:
  ...
  - id: ch4-wetlands-emissions-d-era
    stacCol: lpjwsl-wetlandch4-daygrid-v2
    name: (Daily ERA) LPJ-wsl Model Wetland CH₄ Emissions
    type: raster
    description: Daily CH₄ emissions from wetlands constructed using the LPJ-wsl model
    initialDatetime: newest
    projection:
  ...
  - id: ch4-wetlands-emissions-d-merra
    stacCol: lpjwsl-wetlandch4-daygrid-v2
    name: (Daily MERRA2) LPJ-wsl Model Wetland CH₄ Emissions
    type: raster
    description: Daily CH₄ emissions from wetlands constructed using the LPJ-wsl model
    initialDatetime: newest
    projection:
