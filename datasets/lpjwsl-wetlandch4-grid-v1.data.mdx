...
layers:
  - id: ch4-wetlands-emissions-d-ens
    ...
    name: (Daily-Ensemble Mean) LPJ-wsl Model Wetland CH₄ Emissions
    type: raster
    ...
    analysis:
      metrics:
        - mean          
  - id: ch4-wetlands-emissions-d-jra
    stacCol: lpjwsl-wetlandch4-daygrid-v2
    name: (Daily-JRA55) LPJ-wsl Model Wetland CH₄ Emissions
    type: raster
    description: Daily CH₄ emissions from wetlands constructed using the LPJ-wsl model
    initialDatetime: newest
    projection:
    ...
    zoomExtent:
      ...
      - 20
    sourceParams:
      assets: jra55-ch4-wetlands-emissions
      colormap_name: magma
      rescale:
        - 0
        - 0.2
    ...
    compare:
      datasetId: lpjwsl-wetlandch4-grid-v2
      layerId: ch4-wetlands-emissions-d-jra
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          if (dateFns && datetime && compareDatetime) return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
  ...
  - id: ch4-wetlands-emissions-d-era
    stacCol: lpjwsl-wetlandch4-daygrid-v2
    name: (Daily-ERA5) LPJ-wsl Model Wetland CH₄ Emissions
    type: raster
    description: Daily CH₄ emissions from wetlands constructed using the LPJ-wsl model
    initialDatetime: newest
    projection:
  ...
  - id: ch4-wetlands-emissions-d-merra
    stacCol: lpjwsl-wetlandch4-daygrid-v2
    name: (Daily-MERRA-2) LPJ-wsl Model Wetland CH₄ Emissions
    type: raster
    description: Daily CH₄ emissions from wetlands constructed using the LPJ-wsl model
    initialDatetime: newest
    projection:
