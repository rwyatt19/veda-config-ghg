...
layers:
  ...
  - id: 4b-manure-management-m
    ...
    compare:
      datasetId: epa-emissions-monthly
      layerId: 4b-manure-management-m
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
  ...
  - id: 1a-combustion-stationary-m
    ...
    compare:
      datasetId: epa-emissions-monthly
      layerId: 1a-combustion-stationary-m
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
    legend:
      ...
      stops:
        ...
        - '#ef6a01'
        - '#cc0019'
  - id: 1b2b-natural-gas-production-m
    stacCol: epa-gridded-monthly-emissions
    ...
    compare:
      datasetId: epa-emissions-monthly
      layerId: 1b2b-natural-gas-production-m
      mapLabel: |
        ::js ({ dateFns, datetime, compareDatetime }) => {
          return `${dateFns.format(datetime, 'LLL yyyy')} VS ${dateFns.format(compareDatetime, 'LLL yyyy')}`;
        }
