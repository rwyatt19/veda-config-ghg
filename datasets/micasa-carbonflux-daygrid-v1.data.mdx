...
<Block>
  <Prose>
    ...
    - A unit change of kg Carbon/m2/month to kg Carbon/m2/day
    ...
    ## Disclaimer
    All data is provided to the US GHG Center in Cloud Optimized GeoTIFF (COG) format. Careful quality checks are used to ensure data transformation has been performed correctly.
