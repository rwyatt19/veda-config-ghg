...
usage:
  - url: 'https://us-ghg-center.github.io/ghgc-docs/cog_transformation/micasa-carbonflux-daygrid-v1.html'
    label: Notebook showing data transformation to COG for ingest to the US GHG Center
    title: 'Data Transformation Notebook'
  - url: 'https://us-ghg-center.github.io/ghgc-docs/user_data_notebooks/micasa-carbonflux-daygrid-v1_User_Notebook.html'
...
<Block type='wide'>
  <Prose>
    ...
    - **Temporal Extent:** January 2001 - December 2023
...
<Block>
  <Prose>
    ...
    The full title of this dataset, MiCASA Daily NPP Rh Fire Fuel Fluxes 0.1 degree x 0.1 degree V1, has been shortened for display on the US GHG Center website. The short name of the source dataset is MICASA_D_FLUX, and it is referred to as micasa-carbonflux-daygrid-v1 within the Center system. The source dataset in NetCDF format is available from the NCCS DataPortal (see above). A user guide is available at [LINK TO USER’S GUIDE].

    ## Key Publications
    Weir, B. & Ott, L. E. (2024). Description of MiCASA Version 1 Land Carbon Flux Products. [LINK TO USER’S GUIDE]
    ...
    - [Data Transformation Code](https://us-ghg-center.github.io/ghgc-docs/cog_transformation/micasa-carbonflux-daygrid-v1.html)
