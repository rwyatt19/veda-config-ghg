...
<Block type="wide">
  <Prose>
    **Attention!** 
    The location of the markers in the visualization environment below represent the location of maximum enhancement within a plume and does not indicate a source location.  </Prose>
</Block>
<Block type="wide">
  <Figure>
    <Embed
