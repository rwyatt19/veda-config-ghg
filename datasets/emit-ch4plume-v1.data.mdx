...
<Block type="wide">
  <Prose>
    **Attention!** 
    The location of the markers in the visualization environment below represent the location of maximum concentration of a plume and does not indicate any possible source location. This may result in some markers placed over water for plumes generated close to shore.  
  </Prose>
</Block>
<Block type="wide">
  <Figure>
