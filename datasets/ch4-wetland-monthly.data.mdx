...
usage:
  - url: 'https://github.com/NASA-IMPACT/GHGC_docs/blob/main/cog_transformation_scripts/NASA_GSFC_wetlands_transformation.py'
    ...
    title: 'Wetland methane emissions data trasnsformation notebook'
  - url: 'https://github.com/NASA-IMPACT/GHGC_docs/blob/main/user_data_notebooks/wetland_methane_emissions.ipynb'
    ...
    title: 'Wetland methane emissions data notebook'
media:
...
layers:
  - id: ch4-wetlands-emissions
    ...
    name: Wetlands CH<sub>4</sub> Emissions (Monthly)
    type: raster
    description: Monthly CH<sub>4</sub> emissions from wetlands constructed using the LBJ-wsl model version
    zoomExtent:
      - 0
      - 20
    sourceParams:
    ...
    legend:
      unit: g m<sup>-2</sup> mon<sup>-1</sup>
      type: gradient
      min: 0
      max: 2
      stops:
  ...
  - id: ch4-wetlands-emissions-d
    ...
    type: raster
    description: Daily CH<sub>4</sub> emissions from wetlands constructed using the LBJ-wsl model version
    ...
    legend:
      unit: g m<sup>-2</sup> daily<sup>-1</sup>
      type: gradient
      min: 0
      max: 0.2
      stops:
