...
usage:
  - url: 'https://github.com/NASA-IMPACT/GHGC_docs/blob/main/transformation_scripts/ODIAC_fossil_fuel_geotiff_transformation.py'
    label: Notebook to trasnform GeoTIFF to COG
    title: 'ODIAC CO2 emissions data trasnsformation notebook'
  - url: 'https://github.com/NASA-IMPACT/GHGC_docs/blob/main/jupyter_notebooks/ODIAC_CO2_data_notebook.ipynb'
...
<Block>
  <Prose>
    ...
    [Processing and Confirmation Report](https://github.com/NASA-IMPACT/GHGC_docs/blob/main/Dataset%20Validation_ODIAC.pdf)
