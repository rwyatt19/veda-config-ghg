...
description: ODIAC is a high-spatial resolution (1km x 1km) global emission data product of CO₂ emissions
media:
...
<Block>
  <Prose>
    ...
    Tomohiro Oda, Shamil Maksyutov (2015), ODIAC Fossil Fuel CO2 Emissions Dataset (Version name : ODIAC2022), Center for Global Environmental Research, National Institute for Environmental Studies, doi:10.17595/20170411.001. (Reference date : 2023/06/14)
    ## Related Publication
