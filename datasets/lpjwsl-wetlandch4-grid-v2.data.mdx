...
<Block>
  <Prose>
    ...
    ## Disclaimer
    Note that the source dataset is provided in units of kilograms of methane per meter squared per second (kg CH₄/m2/s) but has been converted to **grams** of methane per meter squared per **day** (g CH₄/m2/day) for the purpose of improved visualization.  
