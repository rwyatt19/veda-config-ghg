...
layers:
  - id: ch4-wetlands-emissions-d-ens
    ...
    type: raster
    description: Daily CH₄ emissions from wetlands constructed using an ensemble of climate forcing data sources input to the LPJ-EOSIM model
...
<Block>
  <Prose>
    ...
    ## Version History
    The current dataset version is v2, which replaced v1 in the US GHG Center in April 2024. Summary of version update changes:
    ...
    - v2 data was delivered to the US GHG Center in Cloud Optimized GeoTIFF (COG) format, whereas v1 data was delivered in NetCDF format and then transformed into COG
    - v2 data is provided in units of kg CH₄/m²/s, whereas v1 data was provided in different units
