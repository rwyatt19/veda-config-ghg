...
usage:
  - url: 'https://github.com/US-GHG-Center/custom-interfaces/tree/main/integrate_additional_dataset_into_NOAA/noaa-cpfp-point/data_processing'
...
<Block>
  <Prose>
    ...
    **Temporal Resolution:** The GHG Center provides only daily and monthly for continuous measurements; temporal resolution varies by station for non-continuous measurements (can be daily up to weekly)<br />
    ...
    **Data Latency:** Updated annually
    ...
    This dataset contains CO₂ concentration measurements made from surface in-situ and tower sites and from surface flask air samples. The surface in-situ and tower instrumentation measures CO2 continuously (hourly, daily and monthly) while the flask air samples are non-continuous measurements (frequency varies by station). Due to the high data volume of hourly tower measurements, daily and monthly averages are generated for display in the US GHG Center. Several surface PFP flask sites have been excluded due to short records: LAC, INX, BWD, NEB, NWB, TMD, SPF, KLM, MKO, MLO, HFM.
...
<Block>
    ...
    - [Non-Continuous Surface Programmable Flask Package (PFP) CO₂ Samples](https://gml.noaa.gov/dv/data/index.php?parameter_name=Carbon%2BDioxide&frequency=Discrete&type=Surface%2BPFP). Due to the shortness of record, the following Surface PFP sites have been excluded: LAC, INX, BWD, NEB, NWB, TMD, SPF, KLM, MKO, MLO, HFM  
    ...
    Due to shortness of record, the following surface PFP flask sites have been excluded:
    LAC, INX, BWD, NEB, NWB, TMD, SPF, KLM, MKO, MLO, HFM

    Due to the high data volume of tower measurements which occur hourly, tower measurements have been aggregated into daily and monthly averages for display in the US GHG Center. 
    ...
    - [Data Transformation Code](https://github.com/US-GHG-Center/custom-interfaces/tree/main/integrate_additional_dataset_into_NOAA/noaa-cpfp-point/data_processing)
