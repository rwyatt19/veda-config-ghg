...
usage:
  - url: 'https://us-ghg-center.github.io/ghgc-docs/cog_transformation/noaa-cpfp-co2-point.html'
...
<Block>
  <Prose>
    ...
    **Data Latency:** Updated annually
    ...
    This dataset contains CO2 concentration measurements made from surface in-situ and tower sites and from surface flask air samples. The surface in-situ and tower instrumentation measures CO2 continuously (hourly, daily and monthly) while the flask air samples are non-continuous measurements (frequency varies by station). Due to the high data volume of hourly tower measurements, daily and monthly averages are generated for display in the US GHG Center. Several surface PFP flask sites have been excluded due to short records: LAC, INX, BWD, NEB, NWB, TMD, SPF, KLM, MKO, MLO, HFM.
